                ...
                <tr key={item.id} className={isWarning ? 'row-warning' : ''}>
                  ...
                  <td className="actions-cell text-right">
                    <div className="actions-group">
                      {isWarning ? (
                        <Button variant="primary" size="sm">Draft PO</Button>
                      ) : (
                        <span className="action-placeholder"></span>
                      )}
                      
                      <div className="secondary-actions">
                        <button className="icon-action-btn" title="Adjust Stock">
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M12 20h9"></path>
                            <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path>
                          </svg>
                        </button>
                        <button className="icon-action-btn text-error" title="Log Waste">
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
