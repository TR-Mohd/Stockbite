...
async def seed_suppliers():
    async with AsyncSessionLocal() as db:
        ...
        new_suppliers = [
            Supplier(id="SUP-JKT-26100", name="Jakarta Central Provisions (Very Long Company Name Which Extends Beyond The Normal Cell Boundaries)", contact_person="Budi Santoso", email="budi@jktprovisions.com", phone="+62 812-3456-7890", address="Jl. Sudirman No. 1", specialization="fresh produce", is_active=True, region="JKT"),
